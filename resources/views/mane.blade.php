...
<body>
  <section class="section section-lg section-main-bunner section-main-bunner-filter text-center">
    <div class="main-bunner-img" style="background-image: url(&quot;https://foodandtravel.mx/wp-content/uploads/2020/12/Aztlan-Por.jpg&quot;); background-size: cover;"></div>
    <div class="main-bunner-inner">
      <div class="container">
        <div class="box-default">
          <h1 class="box-default-title">Bienvenido</h1>
          <div class="box-default-decor"></div>
          <p class="big box-default-text">Bueno esto esta de relleno de momento</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row row-50 justify-content-xl-between align-items-lg-center">
          <div class="col-lg-6 wow fadeInLeft">
            <div class="box-image"><img class="box-image-static" src="https://okdiario.com/img/viajes/2016/10/08/montana-rusa-iron-ratller.jpg" alt="" width="483" height="327"/>
            </div>
          </div>
