...
<body>
    ...
    <section class="section section-lg section-main-bunner section-main-bunner-filter text-center">
        <div class="main-bunner-img"
            style="background-image: url(&quot;https://foodandtravel.mx/wp-content/uploads/2020/12/Aztlan-Por.jpg&quot;); background-size: cover;">
        </div>
        <div class="main-bunner-inner">
            <div class="container">
                <div class="box-default">
                    ...
                    <p class="big box-default-text">Al sistema de venta de entradas para parques de atraccion mas
                        chevere en Bolivia.</p>
                </div>
            </div>
        </div>
    </section>
    <div class="bg-gray-1">
                    ...
                    <div class="row row-50 justify-content-xl-between align-items-lg-center">
                        <div class="col-lg-6 wow fadeInLeft">
                            <div class="box-image"><img class="box-image-static"
                                    src="https://okdiario.com/img/viajes/2016/10/08/montana-rusa-iron-ratller.jpg"
                                    alt="" width="483" height="327" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-5 wow fadeInRight">
                            <h2>Sobre Nosotros</h2>
                            <p>Somos un grupo de desarrolladores humildes con una gran ambicion dispuesto a mejorar, con
                                la intencion de imnovar en el ambito tecnologico.</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer class="section footer-minimal context-dark">
            ...
            <p class="rights"><span>&copy;&nbsp; </span><span
                    class="copyright-year"></span><span>&nbsp;</span><span>Monte
                    mayor</span><span>.&nbsp;</span><span>All Rights Reserved.</span><span>&nbsp;</span></p>
        </footer>
    </div>
